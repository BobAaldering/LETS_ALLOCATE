...
void benchmark_statistics::add_result(const std::tuple<std::string, std::size_t, std::size_t> &result_of_benchmark) {
    m_statistic_information.push_back(result_of_benchmark);
}

const std::vector<std::tuple<std::string, std::size_t, std::size_t>> &benchmark_statistics::get_all_results() const {
